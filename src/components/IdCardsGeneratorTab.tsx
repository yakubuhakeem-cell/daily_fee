                  ...
                  >
                    ...
                    <div className={`mt-[4.5px] px-2.5 py-1.5 flex items-center justify-between border-b ${
                      ...
                      <div className="flex items-center gap-1.5">
                        <div className={`w-4 h-4 rounded-[2px] flex items-center justify-center font-black text-[8px] shrink-0 ${
                          cardDesignStyle === 'bold-banner' ? 'bg-black text-white' : `${getAccentClass('bg')} text-black`
                        }`}>
                          SH
                        </div>
